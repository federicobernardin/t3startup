<?php
namespace TYPO3\CMS\T3Startup\Utility;
...
class Configuration {
	 ...
	 * @var string
	 */
	protected $extensionKey = 't3startup';

	/**
	 * Returns a class instance
	 *
	 * @return \TYPO3\CMS\T3Startup\Utility\Configuration
	 */
	static public function getInstance() {
		return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\CMS\T3Startup\Utility\Configuration');
	}
